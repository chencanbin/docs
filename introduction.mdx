...
EvoLink采用**异步任务架构**，所有AI服务以任务形式处理：
...
<Steps>
  <Step title="注册账户">
    访问 [GPTProto控制台](https://gptproto.com) 完成注册
  </Step>
...
访问 [EvoLink控制台](https://evolink.ai/dashboard) 实时查看：
...
<div align="center">
  ...
  **立即开始您的AI创造之旅**
  ...
  <CardGroup cols={3}>
    <Card title="控制台" icon="browser" href="https://evolink.ai/dashboard">
      管理API密钥和监控使用情况
    </Card>

    <Card title="API文档" icon="book" href="https://docs.evolink.ai/cn/api-manual/image-series/gpt-4o-image-generation">
      查看详细的接口文档
    </Card>

    <Card title="任务管理" icon="list-check" href="https://evolink.ai/dashboard/usage">
      了解任务状态查询
    </Card>
  </CardGroup>
